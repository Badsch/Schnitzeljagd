...
//    }
    ...
    public void setRouteTitle(String s){
    	TextView t = (TextView) findViewById(R.id.hint_view_route);
    	t.setText(s);
    }
    
    public void setHintTitle(String s){
    	TextView t = (TextView) findViewById(R.id.hint_view_title);
    	t.setText(s);    	
    }
    
    public void setHint1(String s){
    	TextView t = (TextView) findViewById(R.id.custom_view_hint1);
    	t.setText(s);
    }
    
    public void setHint2(String s){
    	TextView t = (TextView) findViewById(R.id.custom_view_hint2);
    	t.setText(s);
    }

    public void setHint3(String s){
    	TextView t = (TextView) findViewById(R.id.custom_view_hint3);
    	t.setText(s);
    }

    public void setHint4(String s){
    	TextView t = (TextView) findViewById(R.id.custom_view_hint4);
    	t.setText(s);
    }

    public void setHint5(String s){
    	TextView t = (TextView) findViewById(R.id.custom_view_hint5);
    	t.setText(s);
    }
}
